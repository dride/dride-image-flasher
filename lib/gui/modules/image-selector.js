...
imageWriter.service('ImageSelectorService', function ($q, $rootScope, $timeout, WarningModalService) {
  ...
  this.selectCustomImage = (imgName) => {
    if (imgName === 'drideOSZ') {
      selectionState.setCustomImage('https://s3.amazonaws.com/dride/image_2017-06-21-drideOSZ.zip', imgName)
    }

    if (imgName === 'drideOS') {
      selectionState.setCustomImage('https://s3.amazonaws.com/dride/image_2017-07-28-drideOS-lite.zip', imgName)
    }
  }

...
/**
 * @summary Check if currently downloading
 * @function
 * @private
 *
 * @returns {Boolean} whether is downloading or not
 *
 * @example
 * if (flashState.isDownloading()) {
 *   console.log('We\'re currently downloading a img');
 * }
 */
exports.isDownloading = () => {
  return this.getDownloadStatus() ? true : false;
}
...
/**
 * @summary Set current download status
 * @function
 * @public
 *
 * @description
 *
 * @example
 * flashState.setDownloadStatus();
 */
exports.setDownloadStatus = (status) => {
  this.downloadStatus = status
}

/**
 * @summary Get current download status
 * @function
 * @public
 *
 * @description
 *
 * @example
 * const status = flashState.getDownloadStatus();
 */
exports.getDownloadStatus = () => {
 ...
 */
exports.downloadImageIfNeeded = (imagePath) => {

...
exports.isDownloading = () => {
  return store.getState().toJS().isDownloading
}
...
/**
 * @summary Set the downloading flag
 * @function
 * @private
 *
 * @example
 * flashState.setDownloadingFlag();
 */
exports.setDownloadingFlag = () => {
	store.dispatch({
		type: store.Actions.SET_DOWNLOADING_FLAG
	})
}
...
/**
 * @summary Unset the downloading flag
 * @function
 * @private
 *
 * @description
 ...
 *
 * @example
 * flashState.unsetDownloadingFlag();
 */
exports.unsetFlashingFlag = (results) => {
	store.dispatch({
		type: store.Actions.UNSET_DOWNLOADING_FLAG
	})
}

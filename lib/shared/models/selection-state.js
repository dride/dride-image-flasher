 ...
 */
exports.getImage = () => {
  return this.customImageByPath ? this.customImageByPath : _.get(store.getState().toJS(), [ 'selection', 'image' ])
}
 ...
 */
exports.clearCustomSelection = () => {
  this.customImageByPath = null
  this.customImageName = null
}

/**
 * @summary getCustomImageName
 * @function
 * @public
 * *
 * @example
 * selectionState.getCustomImageName()
 */
exports.getCustomImageName = () => {
  return this.customImageName
}

/**
 * @summary setCustomImage
 * @function
 * @public
 * *
 * @example
 * selectionState.setCustomImage(url, 'drideOS')
 */
exports.setCustomImage = (url, name) => {
  this.customImageByPath = url
